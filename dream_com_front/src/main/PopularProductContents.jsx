...
import "./PopularProductContents.css"
...
function PopularProductContents({name, price, discountPercent}) {
    return (
        <div className={"text-center mt-2"}>
            <p id={"p-main-popular-content"} className={"mb-1 nanumSquareR-font-normal"}>{name}</p>
            <div className={"d-flex justify-content-center"}>
                {
                    discountPercent == 0 ? <p/> : <p id={"p-main-popular-content-sale"} className={"nanumSquareB-font-normal"}>{discountPercent}% </p>
                }
