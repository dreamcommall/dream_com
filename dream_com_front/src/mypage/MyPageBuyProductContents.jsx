        ...
        <div title={orderInfo.productTitle}>
            ...
            <ul>
                <li className={"productInfo mt-1"}>
                    <Link className={"link-my-page-order-product-title"} to={`/detail?productNum=${orderInfo.productNum}&pageNum=1`}>
                        <div className={"nanumSquareR-font-small my-page-buy-product-title"}>
                    ...
                    <div className="accordion nanumSquareR-font-normal mt-3">
                        <div className="accordion-item">
                            <p className="accordion-header">
                                <button disabled={review == null ? true : false} type="button" data-bs-toggle="collapse" className={"accordionButton"} data-bs-target={`#collapse${orderInfo.productNum}`}>
                                    내가 쓴 리뷰 보기
                                </button>
                            </p>
